...
public class updatestep4 extends HttpServlet
{
...
Statement st=con.createStatement();          // create statment 
   String sql= "UPDATE generalinfo SET date4 = '"+f3+"' " + "WHERE airwayno = '"+f2+"'";
   String sql2= "UPDATE generalinfo SET trackinfo4 = '"+f4+"' " + "WHERE airwayno = '"+f2+"'";
   String sql3= "UPDATE generalinfo SET location4 = '"+f5+"' " + "WHERE airwayno = '"+f2+"'";
