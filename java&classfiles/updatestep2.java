...
public class updatestep2 extends HttpServlet
{
...
Statement st=con.createStatement();          // create statment 
   String sql= "UPDATE generalinfo SET date2 = '"+f3+"' " + "WHERE airwayno = '"+f2+"'";
   String sql2= "UPDATE generalinfo SET trackinfo2 = '"+f4+"' " + "WHERE airwayno = '"+f2+"'";
   String sql3= "UPDATE generalinfo SET location2 = '"+f5+"' " + "WHERE airwayno = '"+f2+"'";
