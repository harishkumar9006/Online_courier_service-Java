...
public class updatestep1 extends HttpServlet
{
...
Statement st=con.createStatement();          // create statment 
   String sql= "UPDATE generalinfo SET date1 = '"+f3+"' " + "WHERE airwayno = '"+f2+"'";
   String sql2= "UPDATE generalinfo SET trackinfo1 = '"+f4+"' " + "WHERE airwayno = '"+f2+"'";
   String sql3= "UPDATE generalinfo SET location1 = '"+f5+"' " + "WHERE airwayno = '"+f2+"'";
