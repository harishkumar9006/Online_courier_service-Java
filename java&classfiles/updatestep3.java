...
public class updatestep3 extends HttpServlet
{
...
Statement st=con.createStatement();          // create statment 
   String sql= "UPDATE generalinfo SET date3 = '"+f3+"' " + "WHERE airwayno = '"+f2+"'";
   String sql2= "UPDATE generalinfo SET trackinfo3 = '"+f4+"' " + "WHERE airwayno = '"+f2+"'";
   String sql3= "UPDATE generalinfo SET location3 = '"+f5+"' " + "WHERE airwayno = '"+f2+"'";
